...
export class ProductService {
    ...
    async saveProduct(timestamp: Date, nombre: string, descripcion:string, codigo: string,  foto: string, precio: number, stock: number){
    ...
    async updateProd(prodId: string,timestamp: Date, nombre: string, descripcion:string, codigo: string,  foto: string, precio: number, stock: number){
        const validId = await validateId(prodId)
        if(validId){
